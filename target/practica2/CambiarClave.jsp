...
<body>
    ...
    <div class="infousuariocambio">
        ...
        {
        %>
        <form method="post" action="CambiarClave.html">
            ...
            <div class="formcambio">
                <label for="repetirClave">Repetir la Clave</label>
                <input type="password" id="repetirclave2" name="repetirclave2" required>
            </div>
